		...
		<div class="w3-container w3-responsive">
			<table class="w3-table w3-striped w3-border w3-hoverable w3-small">
				...
				<tbody>
					...
					?>	
					<tr>
						<td><img id="zoneImage" src="../../images/monument/monument_<?php echo $monument['ID_Monument'];?>.png" class="w3-round" alt="Pas d'image"> </td>
						...
						<td><a href="../../controllers/monument/MonumentChercher.php?idMonument=<?php echo $monument['ID_Monument']; ?>&traitement=1"><button class="w3-btn w3-blue w3-round-large w3-hover-green w3-small"><i class="fa fa-eye" ></i>&nbsp;&nbsp;Voir</button></a>&nbsp;&nbsp;
							...
							<a href="../../controllers/monument/MonumentChercher.php?idMonument=<?php echo $monument['ID_Monument']; ?>&traitement=4&nomMonument=<?php echo $monument['Nom_Monument']; ?>"><button class="w3-btn w3-red w3-round-large w3-hover-green w3-small"><i class="fa fa-download" ></i>&nbsp;&nbsp;Télécharger l'image</button></a></td>&nbsp;&nbsp;
						</td>
					</tr>
					<?php
						} } else { ?>
