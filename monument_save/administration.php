...
<a href="controllers/typemonument/LigneMetroListerAccept.php"><button type="button" class="btn btn-primary btn-lg">Ligne metro</button></a>
<a href="controllers/typemonument/TypemonumentListerAccept.php"><button type="button" class="btn btn-primary btn-lg">Stations</button></a>
