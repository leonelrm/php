	...
	<div class="w3-row">
		...
		<div class="w3-half w3-light-grey w3-border w3-card-4">
			...
			<form class="w3-container" action="../../controllers/utilisateur/utilisateurCreerAccept.php" method="post">
				...
				<label>Email</label>
				<input class="w3-input w3-text-blue" type="text" name="email" value="<?php $email; ?>" autofocus>
				
				<label>Password</label>
				<button class="w3-blue" w3-bg-blue><span><i class="fas fa-eye blue"></i></span></button>
				<input class="w3-input w3-text-blue" type="text" name="mdp" value="<?php $mdp; ?>" autofocus>
