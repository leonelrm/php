    ...
    <table border= "1px" class="w3-table">
        ...
        <?php foreach($listeLigneMetro as $ligne) {?>
            <tr>
                ...
                <td> <a href="../../controller/typemonument/TypeMonumentVoir.php?idtypemonument=<?php echo $ligne['ID_TYPE_Monument']; ?>">voir</a>
                     <a href="../../controller/typemonument/typeMonumentModifierAcceptChercher.php?idtypemonument=<?php echo $ligne['ID_TYPE_Monument']; ?>">Modifier</a> 
                     <a href="../../controller/typemonument/TypeMonumentSupprimerAcceptChercher.php?idtypemonument=<?php echo $ligne['ID_TYPE_Monument']; ?>">Supprimer</a></td>            
            </tr>           
            <?php
            }
            ?> 
