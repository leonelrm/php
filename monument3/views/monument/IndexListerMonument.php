...
<body>
	...
	<div class="w3-container">
			...
			<div class="w3-panel w3-card-4">
				...
				<div class="w3-row w3-white">
					<div class="w3-container w3-half ">
						...
						<img id="zoneImage2" src="../../images/monument/monument_<?php echo $monument['ID_Monument'];?>.png" class="w3-circle" alt="Pas d'image">
						<br>
					</div>
					<div class="w3-container w3-half">
		...
		<footer class="w3-brown w3-padding-large">
			<a href="frmMonumentCreer.php" >&nbsp;&nbsp;<button class="w3-btn w3-teal w3-round-large w3-hover-green w3-medium"><i class="fa fa-shopping-basket" ></i>&nbsp;&nbsp;Mon panier</button></a>	
