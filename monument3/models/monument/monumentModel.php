<?php
	...
	function creationPanier(){
		if (!isset($_SESSION['panier'])){
		   ...
		   $_SESSION['panier']['dateCreation'] = array();
		   $_SESSION['panier']['nomMonument'] = array();		   
		   $_SESSION['panier']['verrou'] = false;
		}
		return true;
	 }
	 function ajouterArticle( $nomMonument ,$dateCreation, $idMonument ){

		//Si le panier existe
		if (creationPanier() && !isVerrouille())
		{
		   //Si le produit existe déjà on ajoute seulement la quantité
		   $positionProduit = array_search($nomMonument,  $_SESSION['panier']['nomMonument']);
		   ...
		   else
		   {
			  ...
			  array_push( $_SESSION['panier']['nomMonument'],$nomMonument);
			  array_push( $_SESSION['panier']['dateCreation'],$dateCreation);
			  array_push( $_SESSION['panier']['idMonument'],$idMonument);
		   }
		}
		else
